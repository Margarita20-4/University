...
export default function Mycard () {
  return (<ScrollView style={{marginTop:20}}>
    ...
    <Text style={{ justifyContent: 'center', alignSelf:'center', fontWeight: 'bold', fontSize:30, fontFamily:'lucida grande', color:'blue', margin:10}}>Маргарита Майер</Text>
